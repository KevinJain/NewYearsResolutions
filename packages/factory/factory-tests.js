...
Tinytest.add(
	'Factory - Build - Extend - With attributes (check that we do not modify the parent)',
	function(test) {
		Factory.define('author', Authors, {
			name: 'John Smith'
		})
...
Tinytest.add('Factory - Create - Relationship - return a Factory from function', function(
	test
) {
	Factory.define('author', Authors, {
		name: 'John Smith'
